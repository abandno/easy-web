...
public interface StringKeyMap<V> extends Map<String, V> {
    ...
    default <T> T getValue(String key, Class<T> type, T defaultValue) {
        ...
        return Convert.convert(type, ori, defaultValue);
    }
    ...
    default <T> T getValue(String key, TypeReference<T> type, T defaultValue) {
        Object ori = this.get(key);
        if (ori == null) {
            return defaultValue;
        }
    ...
    default <T> T getValueQuietly(String key, TypeReference<T> type, T defaultValue) {
        Object ori = this.get(key);
        if (ori == null) {
            return defaultValue;
        }
    ...
    default String getString(String key) {
        Object ori = this.get(key);
        return ori == null ? null : String.valueOf(ori);
    }
