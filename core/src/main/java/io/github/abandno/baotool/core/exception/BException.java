 ...
 */
public class BException extends Exception implements IException {
     ...
     */
    public BException(Throwable cause, String msg, Object... args) {
     ...
     */
    public BException(String msg, Object... args) {
     ...
     *
     * @param code 业务错误码
     * @param msg  普通字符串或字符串模板
     * @param args args
     */
    public BException(int code, String msg, Object... args) {
        this(msg, args);
        this.code = code;
    }
    ...
    @Override
    public BException setCode(Integer code) {
        this.code = code;
        return this;
    }
    ...
    @Override
    public BException setErrors(List<String> errors) {
        this.errors = errors;
        return this;
    }

    @Override
    public BException appendErrors(String... errors) {
        return (BException) IException.super.appendErrors(errors);
    }

    @Override
    public BException appendErrors(Collection<String> errors) {
        return (BException) IException.super.appendErrors(errors);
    }

    @Override
    public BException appendError(String template, Object... params) {
        return (BException) IException.super.appendError(template, params);
    }
